<?php
// Admin insights — revenue trends, top products, and order breakdowns.
...
// Summary stat totals
// Revenue logic: kiosk and online qualifying orders
...
<div class="ins-outer-frame" id="insightsFeed">
  <div class="ins-body">
    ...
    <!-- Top items and breakdown charts -->
...
<script>
  ...
  // Color map for order types and payment methods
  const colorMap = {
    'Bank Transfer': '#6B3FA0',
    'Cash': '#5B1312',
    'Cash on Delivery': '#C4842A',
  ...
  // Export the insights feed as a PDF
