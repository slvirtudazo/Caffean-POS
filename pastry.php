 ...
 * This page displays all available pastries and baked goods with pagination.
...
// Count total pastry products (category 3)
...
// Fetch pastry products for the current page
...
<head>
    ...
    <title>Pastry Menu - Purge Coffee</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="pastry.php">Pastry</a>
                    </li>
                    <li class="nav-item">
