...
/**
 * Purge Coffee Shop — Product Interaction Tracker (php/track_interaction.php)
...
// Upsert: increment count if record exists, otherwise insert
$type = $interaction_type; // 'favorite' or 'add_to_cart'
$stmt = mysqli_prepare($conn,
...
mysqli_stmt_bind_param($stmt, 'is', $product_id, $type);
mysqli_stmt_execute($stmt);
mysqli_stmt_close($stmt);
