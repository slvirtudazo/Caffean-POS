...
// Product Interaction Tracker — increments or decrements interaction counts for bestseller ranking.
...
// Validate the product ID and interaction type.
...
// Decrement the favorite count when a product is unfavorited.
...
// Upsert the interaction count: increment if exists, insert otherwise.
$stmt = mysqli_prepare(
    $conn,
